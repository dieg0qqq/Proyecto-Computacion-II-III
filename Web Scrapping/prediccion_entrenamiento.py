...
for columna in columnas_texto:
    ...
    for i in range(len(datos[columna])):
        datos[columna][i] = diccionario[columna][datos[columna][i]]
        
    #Cambia el tipo del dato de objeto a int
    datos[columna] = datos[columna].astype('int32')

print(datos)
print("-------------------------------")
X = datos.drop('retraso',axis=1)
y = datos['retraso']
contador_ejemplares = len(datos[columna])
...
print({'clasificador': clasificador, 'diccionario': diccionario, 
