...
```bash
curl -X POST \
    "http://localhost/api/modelos_prediccion" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```bash
curl -X GET \
    -G "http://localhost/api/aerolinea/lista" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/aerolinea/lista"
);
...
```bash
curl -X GET \
    -G "http://localhost/api/aerolineas/lista" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/aerolineas/lista"
);
...
```bash
curl -X GET \
    -G "http://localhost/api/aerolineas/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/aerolineas/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/api/prediccion_vuelo/1/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/prediccion_vuelo/1/1"
);
